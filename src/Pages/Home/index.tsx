      ...
      <div className="">
        ...
        <div className=" p-6 flex gap-6 justify-around items-center">
          <select
            ...
            className="p-1 rounded w-[20vw] outline-none"
            name="Vehicle"
          >
        ...
        <div className="flex justify-evenly">
          <section className="flex flex-col items-center justify-center gap-3 w-full">
            <div className="py-7 flex items-center">
              <img
                src="https://c4.wallpaperflare.com/wallpaper/900/398/321/anime-demon-slayer-kimetsu-no-yaiba-zenitsu-agatsuma-hd-wallpaper-preview.jpg"
                className="border w-96 rounded-3xl"
              ></img>
            </div>
            <div
              onClick={() => {
              ...
              className="bg-[#14224A] p-2 text-center font-bold rounded-xl w-[10vw] text-white"
            >
              Explore
            </div>
          </section>
