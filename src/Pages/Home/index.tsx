...
const Home = () => {
  ...
  const Handle$Response$VerifyToken = (data: any) => {
    ...
    if (data.status === 500) {
      ...
      dispatch(loginAction.addLogin({ _id: data.data._id, name: data.data.name, email_id: data.data.email_id, mobile_no: data.data.mobile_no, location: data.data.location }))
    }
    ...
    <div>
      ...
      <div className="">
        ...
        <div className=' p-6 flex gap-6 justify-around items-center'>
          <select onChange={Handle$Onchange$VechileType} className=' cursor-pointer p-1 rounded w-[20vw] outline-none' name="Vehicle">
        ...
        <div className='flex justify-evenly'>
          <section className='flex flex-col items-center justify-center gap-3 w-full'>
            <div className='bg-white rounded-2xl opacity-20 mt-20 w-96 h-[65vh] absolute -z-10'>
            ...
            }} className='cursor-pointer rounded-2xl bg-[#14224A] p-2 text-center font-bold w-[10vw] text-white'>Explore</div>
          </section>
          <section className='flex flex-col items-center justify-center gap-3 w-full'>
            <div className='bg-white rounded-2xl opacity-20 mt-20 w-96 h-[65vh] absolute -z-10'>
            ...
            }} className='cursor-pointer bg-[#14224A] p-2 text-center font-bold rounded-xl w-[10vw] text-white'>Explore</div>
          </section>
        </div>
      </div>
    </div>
