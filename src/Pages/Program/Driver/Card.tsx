...
export const Card = ({ cid, id, setcid, driver, Handler }: { cid: number, Handler: any, id: number, setcid: any, driver: any }) => {
    ...
    return (
        <div className='relative w-84 h-72'>
            {
            ...
            >
                <img onLoad={() => setloader(false)} className="w-56 h-48" src={driver.imageurl}></img>
                ...
                <div
                    className={` rounded-xl opacity-80 flex flex-col justify-center items-center gap-5 w-full h-full text-white absolute top-0 left-0 ${cid === id ? "" : "hidden"
                        } bg-slate-700 `}
                >
