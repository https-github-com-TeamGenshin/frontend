  ...
  return (
    <div className='flex items-center py-3 px-6 gap-6 bg-slate-800 text-white'>
      ...
      <div className='flex w-full justify-center gap-28'>
        ...
        {role === "driver" && <>
          <Link to="/driverhome" className="text-2xl">Home</Link>
          <Link to="/driverpending" className="text-2xl">Pending</Link>
          <Link to="/driveraccepted" className="text-2xl">Accepted</Link>
          <Link to="/driverupdate" className="text-2xl">Update Details</Link></>}
      </div>
    </div>
  )
}
