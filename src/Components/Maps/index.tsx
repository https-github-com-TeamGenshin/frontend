...
export const Maps: React.FC = () => {
    ...
    const PlaceChanged = () => {
        if (autoc !== null) {
            setCenter({lat : autoc.getPlace().geometry.location.lat(), lng : autoc.getPlace().geometry.location.lng()})
            ...
            <Box position="absolute" left={0} top={0} h="100%" w="100%">
                ...
                <GoogleMap
                    ...
                    onLoad={(map) => {
                        ...
                        geocoder.geocode({ location: latLng }, (results: GeocoderResult[] | null, status: google.maps.GeocoderStatus) => {
